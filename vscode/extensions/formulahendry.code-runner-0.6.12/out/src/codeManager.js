...
var CodeManager = (function () {
    ...
    CodeManager.prototype.initialize = function (editor) {
        ...
        if ((this._config.get('fileDirectoryAsCwd') || !vscode.workspace.rootPath)
     ...
     */
    CodeManager.prototype.getCodeFileDirWithoutTrailingSlash = function () {
    ...
    CodeManager.prototype.changeExecutorFromCmdToPs = function (executor) {
