...
Click the debugging icon ![Choose React Native debugger](https://github.com/Microsoft/vscode-react-native/raw/master/images/debug-view-icon.png) in the View bar, and then click the configure gear icon ![Configure-gear](https://github.com/Microsoft/vscode-react-native/raw/master/images/configure-gear-icon.png) to choose the React Native debug environment.
...
![React Native launch configuration file](https://github.com/Microsoft/vscode-react-native/raw/master/images/launch-config.png)
...
### Start debug session
To start the debug session, select a configuration from the Configuration dropdown, and then click the start button ![Configure-gear](https://github.com/Microsoft/vscode-react-native/raw/master/images/debug-icon.png) (or press F5).
...
![IntelliSense prompt](https://github.com/Microsoft/vscode-react-native/raw/master/images/intellisense-prompt.png)
