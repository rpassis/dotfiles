...
exports.DOCKERFILE_KEY_INFO = {
    ...
    'ARG': ("Defines a variable that users can specify at build-time, by means of the **--build-arg <varname>=<value>** flag of the **docker build** command."),
    ...
    'HEALTHCHECK': ("Specifies a command that Docker should run within the container, in order to determine whether it's functioning properly."),
    ...
    'SHELL': ("Specifies the default shell that should be used for commands which are written in shell-form (e.g. **RUN npm install**)."),
